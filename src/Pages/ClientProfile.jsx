      ...
      <div className="bg-[#0a0a0f] min-h-screen text-gray-200">
        ...
        <div className="max-w-4xl mx-auto px-6 pt-10 animate-pulse">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-20 bg-[#ffffff08] rounded-lg"></div>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8">
        ...
        <div className="bg-[#ffffff08] border border-gray-700 rounded-xl p-6 mb-6 flex flex-col sm:flex-row gap-5 sm:items-center">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2.5">
              <h1 className="text-xl font-semibold text-gray-50">{client.name}</h1>
              <span className="bg-[#534ab730] border border-[#534AB7] text-[#a5b4fc] text-[11px] font-medium px-2.5 py-0.5 rounded-full">
                Client
              </span>
            ...
            {client.bio && (
              <p className="text-gray-400 text-sm mt-2 leading-relaxed">{client.bio}</p>
            )}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          <div className="bg-[#ffffff08] border border-gray-700 rounded-lg p-4">
            ...
            <p className="text-[20px] font-medium text-gray-50">{stats.totalProjects}</p>
          </div>
          <div className="bg-[#ffffff08] border border-gray-700 rounded-lg p-4">
          ...
          <div className="bg-[#ffffff08] border border-gray-700 rounded-lg p-4">
            ...
            <p className="text-[20px] font-medium text-gray-50">{stats.hireRate}%</p>
          </div>
          <div className="bg-[#ffffff08] border border-gray-700 rounded-lg p-4">
        ...
        <div className="bg-[#ffffff08] border border-gray-700 rounded-xl p-5 mb-6">
          <p className="text-[13px] font-medium text-gray-400 mb-3 flex items-center gap-1.5">
            <TbCurrencyDollar /> Spending Overview
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-[11px] text-gray-500 mb-1">Total Spent (completed)</p>
              <p className="text-[18px] font-medium text-[#a5b4fc]">${stats.totalSpent}</p>
            </div>
            <div>
              <p className="text-[11px] text-gray-500 mb-1">Avg Project Budget</p>
              <p className="text-[18px] font-medium text-[#a5b4fc]">${stats.avgBudget}</p>
            </div>
          </div>
        </div>

        {/* Completion rate note */}
        <div className="bg-[#ffffff08] border border-gray-700 rounded-xl p-5">
          <p className="text-[13px] font-medium text-gray-400 mb-2">Completion Rate</p>
