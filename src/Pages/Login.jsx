...
function Login() {
  ...
  return (
    <div>
        <div className="mt-2">
            <h2 className="text-center text-[30px] text-white font-medium">Login</h2>
            <p className="text-gray-300 text-center text-[15px] font-medium">Apne account mein login karein</p>
        </div>

        <form className="space-y-3 px-6 mt-4" onSubmit={handleLogin}>
            ...
            <p className="text-[#534AB7] text-[15px] text-right cursor-pointer font-medium">Password bhool gaye?</p>
            <button className="border-[1px] mt-3 border-gray-500 text-white w-full h-[39px] font-medium rounded-md hover:bg-[#00000032] text-lg">{loading ? "Loading..." : "Login karein"}</button>
            <div className="flex items-center gap-2">
                <div className="w-full h-[1px] bg-gray-400"></div>
                <div className="text-gray-300 text-[15px]">ya</div>
                <div className="w-full h-[1px] bg-gray-400"></div>
            </div>
            <button className="border-[1px] mt-3 border-gray-500 text-white w-full h-[39px] font-medium rounded-md hover:bg-[#00000032] text-lg flex items-center justify-center gap-2"><SlSocialGoogle className="text-orange-600" /> <span>Google se login karein</span> <MdArrowOutward /></button>
            <div className="flex items-center justify-center">
                <span className="text-gray-300 font-medium mt-2 text-[15px]">Account nahi? <span className="text-[#534AB7] text-[15px] cursor-pointer font-medium" onClick={() => navigate("/auth/signUp")}>Sign up karein</span></span>
            </div>
        </form>
    </div>
  )
